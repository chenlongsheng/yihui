...
public class TDevChannel {
     ...
     * @param chId
     */
    public TDevChannel(String devId, String warn, String realValue, Integer chNo, String name, String monad,
    ...
    public String toString() {
        return "TDevChannel [devId=" + devId + ", warn=" + warn + ", realValue=" + realValue + ", chNo=" + chNo
                + ", name=" + name + ", monad=" + monad + ", chType=" + chType + ", stateName=" + stateName + ", chId="
                + chId + "]";
    }
    /**
     * @return the devId
